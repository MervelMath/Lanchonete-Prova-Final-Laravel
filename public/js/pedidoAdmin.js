$(document).ready(function () {
    ...
    const selectFiltroTipo = $("#id-div-lista-tipos");
    selectFiltroTipo.on("change", function () {
        filtraProdutoPorTipo(selectFiltroTipo.val());
    });

    // const selectPedido = $("#id-div-lista-produto-pedido");
    // selectPedido.on("click", function(){
    //     updatePedidoProdutos(selectPedido.val());
    // });
    ...
    function printSelectProdutos(produtos_group) {
        ...
        divListProdutos = $("#id-div-lista-produto-tipo");
    ...
    function printSelectTipoProdutos(produtos_group) {
        ...
        divListProdutos = $("#id-div-lista-tipos");
     ...
     function printListPedidoProdutos(produtos_group){
        ...
        divListProdutos = $("#id-div-lista-produto-pedido");
