    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="id-div-lista-produto-pedido" class="list-group my-3 overflow-auto">
            ...
            {{-- Parte da direita --}}
            <div class="col-md-3">
                <select id="id-div-lista-tipos" class="form-select my-1">
                    
                </select>

                <select id="id-div-lista-produto-tipo" class="form-select my-1">
                </select>
